...
@Slf4j
@Service
public class TransactionAnalyzer implements TransactionAnalysis {
    ...
    // ---- Grouping methods (delegate to the framework-free bank-common utility) ----
